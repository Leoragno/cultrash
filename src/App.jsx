...
const Q = {
  ...
  piccante: [
    { d: 2, q: "Il Kamasutra è un testo originario di quale paese?", a: ["India", "Giappone", "Grecia", "Egitto"], c: 0, f: "Scritto in sanscrito. E per due terzi parla di corteggiamento e vita sociale." },
    { d: 2, q: "Chi ha scritto «Cinquanta sfumature di grigio»?", a: ["E. L. James", "Stephenie Meyer", "Anaïs Nin", "Erica Jong"], c: 0, f: "Nato come fan fiction di Twilight. La letteratura fa strade misteriose." },
    { d: 2, q: "Quale ormone è soprannominato «ormone delle coccole»?", a: ["Ossitocina", "Adrenalina", "Insulina", "Cortisolo"], c: 0, f: "Si libera con abbracci, baci e allattamento. Anche accarezzando il cane." },
    { d: 2, q: "La filofobia è la paura di...", a: ["Innamorarsi", "Parlare in pubblico", "Essere toccati", "Restare soli"], c: 0, f: "Dal greco «philos», amore. Metà dei tuoi ex, spiegati." },
    { d: 2, q: "Afrodite è la dea greca di...", a: ["Amore e bellezza", "Guerra", "Caccia", "Saggezza"], c: 0, f: "Da lei viene la parola «afrodisiaco»." },
    { d: 2, q: "Qual è il corrispettivo romano di Afrodite?", a: ["Venere", "Giunone", "Minerva", "Diana"], c: 0, f: "Botticelli le ha dedicato il quadro più corteggiato di Firenze." },
    { d: 2, q: "Casanova, il seduttore più famoso della storia, era di quale città?", a: ["Venezia", "Roma", "Napoli", "Palermo"], c: 0, f: "Giacomo Casanova, 1725. Fu anche bibliotecario: finì i suoi giorni tra i libri." },
    { d: 2, q: "Quale cibo Casanova considerava il suo afrodisiaco preferito?", a: ["Le ostriche", "Il tartufo", "Il cioccolato", "Il peperoncino"], c: 0, f: "Ricche di zinco, in effetti. Il resto era marketing personale." },
    { d: 2, q: "Da quale scrittore prende il nome il «sadismo»?", a: ["Marchese de Sade", "Lord Byron", "Baudelaire", "D'Annunzio"], c: 0, f: "E il masochismo dall'austriaco Leopold von Sacher-Masoch." },
    { d: 2, q: "Chi ha reso celebre il termine «libido»?", a: ["Freud", "Jung", "Nietzsche", "Pavlov"], c: 0, f: "Jung poi la ridefinì come energia psichica generale. Litigarono anche per quello." },
    { d: 2, q: "Il «punto G» prende il nome da...", a: ["Un ginecologo tedesco", "Una dea greca", "Un film francese", "Una canzone"], c: 0, f: "Ernst Gräfenberg. Un cognome, un destino." },
    { d: 2, q: "«9 settimane e ½» è un film cult di quale decennio?", a: ["Anni '80", "Anni '60", "Anni 2000", "Anni '90"], c: 0, f: "1986, con Kim Basinger e Mickey Rourke. La scena del frigorifero: sai quale." },
    { d: 2, q: "Nel gergo social, cosa vuol dire «ghosting»?", a: ["Sparire senza spiegazioni", "Fingersi single", "Corteggiare due persone", "Controllare i profili altrui"], c: 0, f: "Cugino stretto del «breadcrumbing»: briciole d'attenzione per tenerti lì." },
    { d: 2, q: "Cos'è una «situationship»?", a: ["Una relazione mai definita", "Una coppia aperta", "Un ex che torna", "Un amico di famiglia"], c: 0, f: "Il limbo dantesco, ma con i messaggi visualizzati alle 2 di notte." },
    { d: 2, q: "Barry White, re delle serate romantiche, è famoso per una voce...", a: ["Bassissima", "Acutissima", "Nasale", "Roca da rock"], c: 0, f: "Basso profondo. Ha venduto oltre 100 milioni di dischi con quel timbro." },
    { d: 2, q: "Quale isola greca è la cartolina più abusata dei tramonti romantici?", a: ["Santorini", "Creta", "Rodi", "Corfù"], c: 0, f: "Le case bianche e blu nascono su una caldera vulcanica. Romanticismo geologico." },
    { d: 2, q: "Il profumo «Opium», scandalo pubblicitario del 1977, è della maison...", a: ["Yves Saint Laurent", "Chanel", "Dior", "Gucci"], c: 0, f: "Le campagne furono censurate in mezzo mondo. Vendette comunque tantissimo." },
    { d: 2, q: "In «Il Gattopardo» la celebre scena del ballo mette in scena soprattutto...", a: ["La tensione tra Angelica e Tancredi", "Un duello", "Un funerale", "Uno sbarco"], c: 0, f: "Visconti ci mise mesi a girarla. Sensualità in guanti bianchi: il massimo livello." },
    { d: 3, q: "A quale periodo risale il Kamasutra?", a: ["III-V secolo d.C.", "XII secolo", "I secolo a.C.", "VIII secolo"], c: 0, f: "Attribuito a Vatsyayana. In Europa arrivò solo nell’Ottocento, con una traduzione semiclandestina." },
    { d: 3, q: "Chi ha scritto «L’amante di Lady Chatterley»?", a: ["D. H. Lawrence", "Henry Miller", "Vladimir Nabokov", "Alberto Moravia"], c: 0, f: "1928. In Gran Bretagna fu processato per oscenità: assolto solo nel 1960." },
    { d: 3, q: "«Delta di Venere» è un’opera di...", a: ["Anaïs Nin", "Marguerite Duras", "Colette", "Erica Jong"], c: 0, f: "Scritti negli anni ’40 per un collezionista che pagava un dollaro a pagina." },
    { d: 3, q: "Chi era Messalina?", a: ["Moglie dell’imperatore Claudio", "Una sacerdotessa greca", "Una regina egizia", "Una poetessa romana"], c: 0, f: "La sua fama scandalosa arriva quasi tutta da fonti ostili. La storiografia moderna ci va cauta." },
    { d: 3, q: "Chi ha diretto «Ultimo tango a Parigi»?", a: ["Bernardo Bertolucci", "Federico Fellini", "Michelangelo Antonioni", "Pier Paolo Pasolini"], c: 0, f: "1972. In Italia le copie furono ordinate al rogo da un tribunale." },
    { d: 3, q: "Quante novelle contiene il Decameron?", a: ["100", "50", "120", "75"], c: 0, f: "Dieci giornate per dieci narratori. Molte sono decisamente spinte." },
    { d: 3, q: "La «Venere di Willendorf» risale a quale periodo?", a: ["Paleolitico", "Neolitico", "Età del bronzo", "Epoca romana"], c: 0, f: "Circa 25.000 anni fa, undici centimetri di calcare. La prima icona del corpo femminile." },
    { d: 3, q: "Chi ha scritto «Lolita»?", a: ["Vladimir Nabokov", "Henry Miller", "D. H. Lawrence", "Philip Roth"], c: 0, f: "1955: rifiutato da quattro editori americani, uscì prima a Parigi." },
    { d: 3, q: "«Tropico del Cancro» è un’opera di...", a: ["Henry Miller", "Charles Bukowski", "Jack Kerouac", "William Burroughs"], c: 0, f: "1934: negli Stati Uniti fu vietato per quasi trent’anni." },
    { d: 3, q: "In quale museo si trova il «Gabinetto Segreto» con i reperti erotici di Pompei?", a: ["Museo Archeologico di Napoli", "Musei Capitolini", "Uffizi", "Museo Egizio di Torino"], c: 0, f: "Per due secoli visitabile solo con permesso speciale." },
    { d: 3, q: "Dove morì Giacomo Casanova?", a: ["In Boemia", "A Venezia", "A Parigi", "A Napoli"], c: 0, f: "Bibliotecario nel castello di Dux: finì i suoi giorni tra i libri e i ricordi." },
    { d: 2, q: "Chi ha scolpito «Il bacio», la celebre scultura di due amanti abbracciati?", a: ["Auguste Rodin", "Antonio Canova", "Gian Lorenzo Bernini", "Michelangelo"], c: 0, f: "1889. Nacque come dettaglio di un'opera più grande, poi diventò celebre da sola." },
    { d: 2, q: "Il film «Dirty Dancing» è ambientato in quale decennio?", a: ["Anni '60", "Anni '50", "Anni '70", "Anni '80"], c: 0, f: "Estate 1963, in un resort di villeggiatura. Il ballo finale resta il più imitato della storia del cinema." },
    { d: 2, q: "Chi ha diretto il thriller erotico «Basic Instinct»?", a: ["Paul Verhoeven", "Adrian Lyne", "Brian De Palma", "David Fincher"], c: 0, f: "1992. La scena dell'interrogatorio fece discutere per anni, ben oltre la trama." },
    { d: 2, q: "Da quale dea prende il nome la parola «afrodisiaco»?", a: ["Afrodite", "Era", "Artemide", "Demetra"], c: 0, f: "Tutto ciò che «risveglia» l'amore porta il suo nome da millenni." },
    { d: 3, q: "Chi si nasconde dietro lo pseudonimo Pauline Réage, autrice di «Histoire d'O»?", a: ["Anne Desclos", "Simone de Beauvoir", "Marguerite Yourcenar", "Colette"], c: 0, f: "Rivelò la sua identità solo nel 1994, a quasi 40 anni dalla pubblicazione del libro." },
    { d: 3, q: "I Lupercalia, riti di fertilità dell'antica Roma a metà febbraio, erano dedicati al dio...", a: ["Fauno", "Marte", "Bacco", "Vulcano"], c: 0, f: "Si dice siano all'origine, molto alla lontana, di San Valentino." },
    { d: 3, q: "In quale secolo visse Saffo, la poetessa greca di Lesbo celebre per i suoi versi d'amore?", a: ["VII-VI secolo a.C.", "IV-III secolo a.C.", "I secolo d.C.", "X secolo a.C."], c: 0, f: "Di lei restano solo frammenti: un intero papiro con versi suoi è un evento archeologico." },
    { d: 3, q: "L'«Ars Amatoria», manuale poetico di seduzione, è opera di quale autore latino?", a: ["Ovidio", "Virgilio", "Orazio", "Catullo"], c: 0, f: "Gli costò, insieme ad altri motivi mai del tutto chiariti, l'esilio voluto da Augusto." },
  ],
};
...
function Host({ onExit }) {
  ...
  function draw(cat) {
    const pool = Q[cat];
    const allowed = pool.map((_, i) => i).filter((i) => cfgRef.current.pool.includes(pool[i].d));
